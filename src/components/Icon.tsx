const PATHS: Record<string, string> = {
  ...
  flame: 'M12 22c4 0 7-3 7-7 0-5-5-7-5-12-3 2-6 6-6 9-1-1-2-2-2-4-1 2-2 4-2 7 0 4 4 7 8 7z',
...
export function Icon({ name, size = 20, className = 'nav-icon' }: { name: keyof typeof PATHS | string; size?: number; className?: string }) {
  return (
