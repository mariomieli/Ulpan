...
export const LESSONS: Lesson[] = [
  ...
  },
  {
    ...
    theory: [
      ...
      { type: 'tip', text: 'A volte il punto del cholam si fonde con un altro punto: in מֹשֶׁה (Moshe) il cholam della מ coincide con il punto della שׁ, e in שֹׂנֵא (sone) con il punto del sin.' },
    ],
  },
  {
    id: 5,
  ...
  },
  {
    ...
    theory: [
      ...
      { type: 'p', text: 'Lo sheva ( ְ due punti verticali) di solito è muto, anche a inizio parola: זְמַן “zman”, בְּרָכָה “bracha”, סְפָרִים “sfarim”. Si pronuncia come una “e” brevissima (sheva na) soprattutto con i prefissi בְּ לְ וְ מְ (בְּבַקָּשָׁה “bevakasha”), a inizio parola sotto י ל מ נ ר (יְלָדִים “yeladim”, לְבָנָה “levana”, מְאֹד “meod”, רְחוֹב “rechov”) e davanti a una gutturale (שְׁאֵלָה “sheela”).' },
      { type: 'p', text: 'Le lettere gutturali (א ה ח ע) non prendono lo sheva pronunciato: al suo posto hanno i chataf, vocali brevi: ֲ “a”, ֱ “e”, ֳ “o” (אֲנִי “ani”). Lo sheva muto invece lo portano normalmente: מַחְשֵׁב “machshev”.' },
      { type: 'example', he: 'אֲנִי', translit: 'ani', note: 'io' },
      { type: 'example', he: 'לֶחֶם', translit: 'lechem', note: 'pane' },
      { type: 'tip', text: 'Patach “furtivo”: sotto ח, ע o הּ finali il patach si legge PRIMA della consonante. רוּחַ = “ruach”, non “rucha”; גָּבוֹהַּ = “gavoa”.' },
    ],
  },
  {
    id: 8,
  ...
  },
  {
    ...
    theory: [
      ...
      { type: 'list', items: [
        ...
        'Kamatz katan: in sillaba chiusa e non accentata il kamatz si legge “o”: כׇּל “kol”, חׇכְמָה “chochma”, תׇּכְנִית “tochnit”. Nei testi moderni si distingue con un segno un po’ più lungo (ׇ). In questo corso le parole con kamatz katan sono state evitate.',
      ] },
